        ...
        <>
            <Grid container sx={{ justifyContent: "center" }}>
                ...
                <Grid lg={12} md={12} sm={12} xs={12} container>
                    <Grid container gap={1.1} marginTop={3}>

                        {img.map((images) => (

                            <Grid lg={3.8} md={3.8} sm={3.6} xs={5.8} >
                ...
                {/* <Grid container gap={1.1} marginTop={3}>
                            <Grid lg={3.9} border={'1px solid black'}>
                                <Card invertedColors={false} orientation="vertical" size="xs" variant="plain" >
                                    <CardOverflow>
                                        <img src='https://ii2.pepperfry.com/media/catalog/product/1/-/494x544/1-seater-manual-recliner-in-brown-colour-by-bantia-furniture-1-seater-manual-recliner-in-brown-colou-3hwtnq.jpg' alt="" width='100%' height={'100%'} />
                                        <IconButton
                                            aria-label="Like minimal photography"
                                            size="xs"
                                            variant="soft"
                                    ...
                                    <CardOverflow  >
                                        <CardContent orientation="horizontal" variant="soft" >
                                            <Grid container marginTop={1}>
                                                ...
                                                <Grid lg={12}>
                                                    <Typography color={'#848484'} fontSize={{ xs: '10px', sm: "12px", md: '12px', lg: "12px" }} fontFamily={'Manrope,sans-serif'} noWrap>
                                                        By Bantia Furniture

                                                    </Typography>
                                                </Grid>
                                                <Grid lg={12}>
                                                    <Typography color={'#67ad5b'} fontSize={{ xs: '10px', sm: "12px", md: '12px', lg: "12px" }} fontFamily={'Manrope,sans-serif'} noWrap>
                                                        <b> Today's Deal</b>

                                                    </Typography>
                                                </Grid>
                                                <Grid lg={12}>
                                                    <Typography color={'#121212'} fontSize={{ xs: '10px', sm: "12px", md: '12px', lg: "14px" }} fontFamily={'Manrope,sans-serif'} noWrap>
                                                        <b> ₹23,199</b> <strike style={{ color: "#848484" }}> ₹ 56,000</strike>

                                                    </Typography>
                                                </Grid>
                                                <Grid>
                                                    <Typography level="body-xs" fontWeight="md" color={'#848484'} fontSize={'12px'} fontFamily={'Manrope,sans-serif'}>
                                                        <span><b>you save ₹ 32,801 </b></span><span style={{ color: "#67ad5b" }}> <b>(59% off)</b></span>
                                                    </Typography>
                                                </Grid>
                                                <Grid lg={12}>
                                                    <Typography color={'#1979B5'} fontSize={{ xs: '10px', sm: "12px", md: '12px', lg: "12px" }} fontFamily={'Manrope,sans-serif'} noWrap>
                                                        Extra cashback worth <b>₹ 464</b>

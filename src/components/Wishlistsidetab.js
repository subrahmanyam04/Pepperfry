    ...
    return (
        <>
            ...
            <Grid container sx={{ justifyContent: "center", marginTop: "20px" }}>
                ...
                <Grid lg={9} md={9} sm={9.5} xs={12} marginBottom={10} >
                    ...
                    >
                        ...
                        <Grid lg={0.2} md={0.2} sm={0.2} xs={12}></Grid>
                        <Grid lg={7.8} md={8.5} sm={8.5} xs={12} border={'1px solid black'} marginTop={{xs:"5px",lg:'0px',md:'0px',sm:'0px'}}>
